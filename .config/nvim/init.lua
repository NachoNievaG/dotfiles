...
vim.keymap.set('n', '}', '}zzzv', opts)
vim.keymap.set('n', '<C-d>', '<C-d>zzzv', opts)
vim.keymap.set('n', '<C-u>', '<C-u>zzzv', opts)
-- resize
vim.keymap.set('n', '<Up>', ':resize +2<CR>', opts)
vim.keymap.set('n', '<Down>', ':resize -2<CR>', opts)
vim.keymap.set('n', '<Left>', ':vertical resize -2<CR>', opts)
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'go', 'haskell', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'vim', 'vimdoc' },
