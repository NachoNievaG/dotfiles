...
;; Scrolls with C-d and C-u and centers after the scroll
	(evil-define-key 'normal 'global (kbd "C-d")
	(lambda () (interactive) (scroll-up) (evil-scroll-line-to-center nil)))

	(evil-define-key 'normal 'global (kbd "C-u")
	(lambda () (interactive) (scroll-down) (evil-scroll-line-to-center nil)))
  (evil-define-key 'normal 'global (kbd "{") (lambda () (interactive) (evil-backward-paragraph) (evil-scroll-line-to-center nil)))
  (evil-define-key 'normal 'global (kbd "}") (lambda () (interactive) (evil-forward-paragraph) (evil-scroll-line-to-center nil)))
  ;
  ...
  (evil-define-key 'normal 'global (kbd "<leader> g j") 'diff-hl-next-hunk) ;; Next diff hunk
  (evil-define-key 'normal 'global (kbd "<leader> g k") 'diff-hl-previous-hunk) ;; Previous diff hunk
